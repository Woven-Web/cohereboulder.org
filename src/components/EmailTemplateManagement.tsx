  ...
  const loadTemplates = async () => {
    try {
      const { data, error } = await supabase
        ...
        .select(
          "id, name, subject, html_content, markdown_content, description, created_at, updated_at",
        )
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage email templates sent to users. Use {`{{variable_name}}`} for
            dynamic content.
          </p>
        </div>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="max-w-[90vw] h-[90vh] overflow-hidden flex flex-col">
            <DialogHeader>
              ...
              <DialogDescription>
                Write your email in Markdown. Available variables:{" "}
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Used to identify the template in code. Cannot be changed
                      after creation.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-muted-foreground mt-1">
                      💡 Tip: Use Markdown syntax. Your content will be
                      automatically wrapped in COHERE branding.
                    </p>
                  </div>
                </TabsContent>
